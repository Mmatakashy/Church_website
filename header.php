...
<title>mountain Of Deliverance - Kongasis</title>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-4 col-sm-6 col-xs-8">
            <h1 class="logo"> <a href="index.php"><img src="images/KCA.jpg" alt="Logo"></a> </h1>
          </div>
          ...
          <div class="col-md-12">
            <nav class="navigation">
              <ul class="sf-menu">
				...
				<ul class="dropdown">
                    <li><a href="our-excos.php">National Headquator</a></li>
                  </ul>
                </li>
